        ...
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="middleInitial" name="middleInitial" placeholder="M" maxLength={1} />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="phone" name="phone" type="tel" placeholder="(248) 555-0123" required />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="zipCode" name="zipCode" placeholder="48342" required />
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="highSchool" name="highSchool" placeholder="High school name" required />
                      </div>
                      <div>
                        <Label htmlFor="hsGradYear">Graduation Year</Label>
                        <Input id="hsGradYear" name="hsGradYear" type="number" placeholder="2020" min="1950" max="2030" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="college" name="college" placeholder="Institution name" />
                      </div>
                      <div>
                        <Label htmlFor="degree">Degree</Label>
                        <Input id="degree" name="degree" placeholder="e.g., BSN, DPT, MSW" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="major" name="major" placeholder="Field of study" />
                      </div>
                      <div>
                        <Label htmlFor="collegeGradYear">Graduation Year</Label>
                        <Input id="collegeGradYear" name="collegeGradYear" type="number" placeholder="2024" min="1950" max="2030" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="license" name="license" placeholder="License number" />
                      </div>
                      <div>
            ...
            <div className="flex justify-between pt-6 border-t">
              <Button type="button" variant="outline" onClick={prevStep} disabled={currentStep === 1} className="bg-transparent">
                Previous
              </Button>
